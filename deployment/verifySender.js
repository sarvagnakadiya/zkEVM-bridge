...
// npx hardhat verify 0x4F9884a1fE709aaa376b8F00Faf5383C59284EcB "0xF6BEEeBB578e214CA9E23B0e9683454Ff88Ed2A7" --network polygonZKEVMTestnet

async function main() {
  const networkName = process.env.HARDHAT_NETWORK;
  const pathDeployOutputParameters = path.join(
    __dirname,
    "./pingPong_output.json"
  );
